...
Properties {
	...
	_FrontTex1("1 Front (+Z)", 2D) = "white" {}
    _BackTex1("1 Back (-Z)", 2D) = "white" {}
    _LeftTex1("1 Left (+X)", 2D) = "white" {}
    _RightTex1("1 Right (-X)", 2D) = "white" {}
    _UpTex1("1 Up (+Y)", 2D) = "white" {}
    _DownTex1("1 Down (-Y)", 2D) = "white" {}

...
public class Movement : MonoBehaviour {
    ...
    private void RotateForwardVec()
    {
        ...
        {                                                                                           //If the diff vec is not 0
            ...
            {                                                                                                                           //If were in the left or right quadrant but in the back half
